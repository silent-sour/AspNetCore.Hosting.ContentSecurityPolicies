...
namespace AspNetCore.Hosting.ContentSecurityPolicies.Models
{
    ...
    public class ContentSecurityPolicy
    {
        ...
        /// </summary>
        public HashSet<string> DefaultSrc { get; set; } = [];
        /// <summary>
        /// Defines valid sources of fonts. 
        /// </summary>
        public HashSet<string> FontSrc { get; set; } = [];
        /// <summary>
        ...
        /// </summary>
        public HashSet<string> FormAction { get; set; } = [];
        ...
        /// </summary>
        public HashSet<string> FrameAncestors { get; set; } = [];

        /// <summary>
        /// Specifies valid sources for nested browsing contexts loading using elements such as <frame> and <iframe>.
        /// </summary>
        public HashSet<string> FrameSrc { get; set; } = [];
        /// <summary>
        /// Specifies valid sources of images and favicons.
        /// </summary>
        public HashSet<string> ImgSrc { get; set; } = [];
        /// <summary>
        /// Specifies valid sources of application manifest files.
        /// </summary>
        public HashSet<string> ManifestSrc { get; set; } = [];
        /// <summary>
        /// Defines valid sources of audio and video, eg HTML5 <audio>, <video> elements. 
        /// </summary>
        public HashSet<string> MediaSrc { get; set; } = [];
        /// <summary>
        /// Defines valid sources of stylesheets. 
        /// </summary>
        public HashSet<string> StyleSrc { get; set; } = [];
        /// <summary>
        /// Defines valid sources for inline styles applied to individual DOM elements. 
        /// </summary>
        public HashSet<string> StyleSrcAttr { get; set; } = [];
        /// <summary>
        /// Defines valid sources for stylesheet <style> elements and <link> elements with rel="stylesheet".
        /// </summary>
        public HashSet<string> StyleSrcElem { get; set; } = [];
        /// <summary>
        /// Defines valid sources of JavaScript. 
        /// </summary>
        public HashSet<string> ScriptSrc { get; set; } = [];
        /// <summary>
        /// Defines valid sources for JavaScript inline event handlers.
        /// </summary>
        public HashSet<string> ScriptSrcAttr { get; set; } = [];
        /// <summary>
        /// Defines valid sources for JavaScript <script> elements.
        /// </summary>
        public HashSet<string> ScriptSrcElem { get; set; } = [];
        /// <summary>
        /// Defines valid sources of plugins, eg <object>, <embed> or <applet>. 
        /// </summary>
        public HashSet<string> ObjectSrc { get; set; } = [];
        ...
        /// </summary>
        public HashSet<string> WorkerSrc { get; set; } = [];
