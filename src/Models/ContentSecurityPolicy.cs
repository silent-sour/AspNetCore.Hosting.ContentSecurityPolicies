...
namespace AspNetCore.Hosting.ContentSecurityPolicies.Models
{
    public class ContentSecurityPolicy
    {
        ...
        /// </summary>
        public HashSet<string> ChildSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Applies to XMLHttpRequest (AJAX), WebSocket or EventSource. If not allowed the browser emulates a 400 HTTP status code. 
        /// </summary>
        public HashSet<string> ConnectSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        ...
        /// </summary>
        public HashSet<string> DefaultSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Defines valid sources of fonts. 
        /// </summary>
        public HashSet<string> FontSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        ...
        /// </summary>
        public HashSet<string> FormAction { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        ...
        /// </summary>
        public HashSet<string> FrameAncestors { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };

        /// <summary>
        /// Specifies valid sources for nested browsing contexts loading using elements such as <frame> and <iframe>.
        /// </summary>
        public HashSet<string> FrameSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Specifies valid sources of images and favicons.
        /// </summary>
        public HashSet<string> ImgSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Specifies valid sources of application manifest files.
        /// </summary>
        public HashSet<string> ManifestSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Defines valid sources of audio and video, eg HTML5 <audio>, <video> elements. 
        /// </summary>
        public HashSet<string> MediaSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Defines valid sources of stylesheets. 
        /// </summary>
        public HashSet<string> StyleSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Defines valid sources for inline styles applied to individual DOM elements. 
        /// </summary>
        public HashSet<string> StyleSrcAttr { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Defines valid sources for stylesheet <style> elements and <link> elements with rel="stylesheet".
        /// </summary>
        public HashSet<string> StyleSrcElem { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Defines valid sources of JavaScript. 
        /// </summary>
        public HashSet<string> ScriptSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Defines valid sources for JavaScript inline event handlers.
        /// </summary>
        public HashSet<string> ScriptSrcAttr { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Defines valid sources for JavaScript <script> elements.
        /// </summary>
        public HashSet<string> ScriptSrcElem { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        /// <summary>
        /// Defines valid sources of plugins, eg <object>, <embed> or <applet>. 
        /// </summary>
        public HashSet<string> ObjectSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
        ...
        /// </summary>
        public HashSet<string> WorkerSrc { get; set; } = new HashSet<string>() { ContentSecurityPolicyResources.Self };
    }
}
